...
@dataclass
class PaperProcessingMetrics:
    """Tracks outcomes for a single data-collection run.

    total    – total candidate papers considered
    inserted – successfully retrieved and stored as new rows
